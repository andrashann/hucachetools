...
const newButtons = [
  { id: 'mpts', class: 'mpts', title: 'Multipontok összekötése', onClick: 'joinMultiPoints()', textContent: '☍' },
  { id: 'dlmpts', class: 'dlmpts', title: 'Összekötés letöltése GPX-ként', onClick: 'dlMultiPointJoins()', textContent: '⤓' },
  { id: 'lgpx', class: 'lgpx', title: 'GPX file betöltése', onClick: 'loadGPX()', textContent: 'ᓬ' },
]
